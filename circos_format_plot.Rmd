...
# dev.off()
# heterozygosity plot
# I think she used -log10 of Cochran p-value not the I value
# this line below should be commented out once the data is processed correctly,
# i.e. either changed to be p-value or filtered (or both)
#het.data <- sample_n(het.data, size = 100)
